...
import { Product, CreateProductRequest, UpdateProductRequest, ApiResponse, PagedResponse } from '../models';
...
export class ProductService {
  ...
  searchProducts(params: any): Observable<PagedResponse<Product>> {
    return this.http.getPaged<Product>(`${this.endpoint}/search`, params);
  }
  ...
  getProductsByCategory(categoryId: number): Observable<ApiResponse<Product[]>> {
    return this.http.get<ApiResponse<Product[]>>(`${this.endpoint}/category/${categoryId}`);
  }

  searchProductsByTerm(term: string): Observable<ApiResponse<Product[]>> {
    return this.http.get<ApiResponse<Product[]>>(`${this.endpoint}/search?term=${encodeURIComponent(term)}`);
  }
